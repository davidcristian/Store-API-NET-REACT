...
namespace StoreAPITest
{
    ...
    public class GetStoresByEmployeeCount
    {
        ...
        [Test]
        public async Task GetStoresByEmployeeCount_ReturnsExpectedResult()
        {
            ...
            Assert.That(shifts[1].Id, Is.EqualTo(3));
            Assert.That(shifts[2].Id, Is.EqualTo(1));
            Assert.That(shifts[0].Headcount, Is.EqualTo(2));
            Assert.That(shifts[1].Headcount, Is.EqualTo(1));
            Assert.That(shifts[2].Headcount, Is.EqualTo(0));
        }
    }
}
