          ...
          <form>
            ...
            <TextField
              ...
              onChange={(event) =>
                setUser({
                  ...user,
                  birthday: new Date(event.target.value).toISOString(),
                })
              }
            />
            ...
            <FormControl fullWidth>
              ...
              >
                {getEnumValues(MaritalStatus).map((maritalStatusValue) => (
                  <MenuItem key={maritalStatusValue} value={maritalStatusValue}>
