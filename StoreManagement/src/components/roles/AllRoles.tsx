...
export const AllRoles = () => {
  ...
  const fetchRoles = async () => {
    ...
    try {
      ...
      console.log(error);
      openSnackbar("error", "Failed to fetch roles due to an unknown error!");
    }
  };
  ...
  return (
    <Container>
      ...
      {!loading && roles.length === 0 && (
        <p data-testid="test-all-roles-empty" style={{ marginLeft: 16 }}>
          No roles found.
        </p>
      )}
      {!loading &&
              ...
              <Grid item xs={12} sm={6} md={4} key={role.id}>
                <Card>
                  ...
                  <CardActions>
                    ...
                    >
                      <Tooltip title="View role details" arrow>
